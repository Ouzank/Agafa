      ...
      Column(children: [
        ...
        Padding(
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  myTextFormField("Email", Icons.email, userController.email,
                      "Entrez l'e-mail"),
                  const SizedBox(
                    height: 10,
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text('Pas de compte ?',
                          style: GoogleFonts.comicNeue()),
                      TextButton(child:Text('S\'inscrire',style: GoogleFonts.comicNeue(color: mainColor)), onPressed: ()=>Get.to(SignUp()),),
                    ],
                  )
                ],
              )),
